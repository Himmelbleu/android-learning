...
import com.example.shopping.adapters.HomeGoodsItemsAdapter;
import com.example.shopping.R;
import com.example.shopping.adapters.HomeTopBannerAdapter;
import com.example.shopping.entities.Goods;
import com.example.shopping.entities.HomeClassify;
...
public class HomeFragment extends Fragment {
  ...
  private final ArrayList<SlideShow> banners;
  private final HomeClassify[] homeClassifies;
  ...
  public HomeFragment() {
    ...
    homeClassifies = new HomeClassify[]{
      new HomeClassify("https://cdn.cnbj0.fds.api.mi-img.com/b2c-shopapi-pms/pms_1656673888.59622325.png", "小米上新"),
      new HomeClassify("https://cdn.cnbj0.fds.api.mi-img.com/b2c-shopapi-pms/pms_1656916095.70948543.png", "手机"),
      new HomeClassify("https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/3d47879ec183e25a36e67e0219636e60.jpg?thumb=1&w=293&h=375&f=webp&q=90", "小米发布"),
      new HomeClassify("https://cdn.cnbj0.fds.api.mi-img.com/b2c-shopapi-pms/pms_1628162373.00133777.jpg", "电视"),
      new HomeClassify("https://cdn.cnbj1.fds.api.mi-img.com/nr-pub/202210241109_a0be0f18375219a87ffd0ae36e49d277.png", "空冰洗"),
      new HomeClassify("https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/609d0a457c7f8ac27d76f953c8acb7fc.jpg?thumb=1&w=250&h=250&f=webp&q=90", "小金商城"),
      new HomeClassify("https://cdn.cnbj0.fds.api.mi-img.com/b2c-shopapi-pms/pms_1560510426.98522616.jpg", "小米众筹"),
      new HomeClassify("https://cdn.cnbj0.fds.api.mi-img.com/b2c-shopapi-pms/pms_1666753567.54218064.png", "电脑/平板"),
      new HomeClassify("https://cdn.cnbj0.fds.api.mi-img.com/b2c-shopapi-pms/pms_1585735675.4495923.jpg", "生活电器"),
      new HomeClassify("https://cdn.cnbj0.fds.api.mi-img.com/b2c-shopapi-pms/pms_1617024738.06472917.jpg", "智能家居"),
    };
  }
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    ...
    banner.addBannerLifecycleObserver(this).setAdapter(new HomeTopBannerAdapter(banners, this)).setIndicator(new CircleIndicator(getContext()));
    ...
    HomeGoodsItemsAdapter adapter = new HomeGoodsItemsAdapter(goods, this);
  ...
  private void createClassifyList(View inflate) {
    ...
    for (HomeClassify homeClassify : homeClassifies) {
      ...
      Glide.with(this).load(homeClassify.getImageUrl()).into(imageView);

      linearLayout.addView(imageView);

      TextView textView = new TextView(getContext());
      textView.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT));
      textView.setText(homeClassify.getLabel());
